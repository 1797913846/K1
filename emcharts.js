...
/***/ (function (module, exports, __webpack_require__) {
			...
			var ChartTime = (function () {
				...
				ChartTime.prototype.init = function () {
					...
					this.options.color.fillStyle = '#333333';
...
/***/ (function (module, exports, __webpack_require__) {
			...
			var ChartK = (function () {
				...
				ChartK.prototype.init = function () {
					...
					this.options.up_color = "#e46943";
					this.options.down_color = "#00b07c";
					...
					this.options.color = {};
					//下面的框左右的边线
					this.options.color.strokeStyle = 'rgba(153,153,153,0.4)';
					this.options.color.fillStyle = '#333333';
			...
			function drawMACD(ctx, dea, diff, macd) {
				...
				for (var i = 0; i < macd_length; i++) {
					...
					if (macd[i].value >= middle) {
						ctx.strokeStyle = "#e46943";
						ctx.fillStyle = "#e46943";
